...
echo "############################################"
echo "Quitting XCode and Simulator... (give it 5 seconds)"
...
echo "############################################"
echo "======== COCOAPODS ======== "
echo "Note that this assumes that your cocoapods have been installed in /sgoinfre/goinfre/Perso/$login/.cocoapods/ > As SGoinfre is a network drive, the initial Cocoapods install process (to run after you hvae changed the .cocoapods location) is quite slow." 
